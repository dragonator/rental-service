...
func TestRentalHandler_GetRentalByID(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: id",
			},
		},
	}
...
func TestRentalHandler_ListRentals(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedCode:         http.StatusBadRequest,
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: unmashalling query: schema: error converting value for index 0 of \"ids\"",
			},
		},
		{
			name:  "PriceMin",
		...
		},
		{
			...
			expectedCode:         http.StatusBadRequest,
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: unmashalling query: schema: error converting value for \"price_min\"",
			},
		},
		{
			name:  "PriceMax",
		...
		},
		{
			...
			expectedCode:         http.StatusBadRequest,
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: unmashalling query: schema: error converting value for \"price_max\"",
			},
		},
		{
			name:  "Near",
		...
		},
		{
			...
			expectedCode:         http.StatusBadRequest,
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: invalid number of values for near (expected 2)",
			},
		},
		{
			name:                 "Invalid Near",
			...
			expectedCode:         http.StatusBadRequest,
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: unmashalling query: schema: error converting value for index 0 of \"near\"",
			},
		},
		{
			name:  "Limit",
		...
		},
		{
			...
			expectedCode:         http.StatusBadRequest,
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: unmashalling query: schema: error converting value for \"limit\"",
			},
		},
		{
			name:  "Offset",
		...
		},
		{
			...
			expectedCode:         http.StatusBadRequest,
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: unmashalling query: schema: error converting value for \"offset\"",
			},
		},
		{
			name:  "Sort",
		...
		},
		{
			...
			expectedCode:         http.StatusBadRequest,
			expectedError: contract.ErrorResponse{
				Message: "invalid query parameters: unexpected sort field: expected one of [id name type make model year length sleeps price_per_day]",
			},
		},
		{
			name:  "All filters",
